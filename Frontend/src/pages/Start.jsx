      ...
      <div className='absolute top-0 w-full h-screen flex flex-col justify-end'>
        <div className='h-[30%] p-5 bg-white relative'>
          ...
          <form action="#" className='mt-4' onSubmit={(e)=>submitHandler(e)}>
            ...
            <input onClick={()=>{ setPanelOpen(true) }} value={pickup} onChange={(e)=>setPickup(e.target.value)} type="text" placeholder='Enter Your Pickup Point' className='bg-[#eee] px-12 py-2 text-base rounded-lg w-full mb-4'/>
            <input onClick={()=>{ setPanelOpen(true) }} value={destination} onChange={(e)=>setDestination(e.target.value)} type="text" placeholder='Enter Your Destination' className='bg-[#eee] px-12 py-2 text-base rounded-lg w-full mb-4'/>
          </form>
        </div>
